...
**Your outputs:**
1. `dev-plan.md` — The canonical development plan
2. `progress.json` — Machine-readable task tracker
...
- You **write** dev-plan.md + progress.json
...
3. Unidirectional: `shared → features → app`
4. Shared UI in `src/components/`, not inside features
</frontend_structure>
...
### Step 5: Generate dev-plan.md and progress.json
</process>
...
```json
{
  ...
  "generated": "[ISO DATE]",
  "source": "ui-ux-plan.md",
  "frontendArchitecture": "bulletproof-react",
  "phases": [
    {
      "id": "phase-0",
      "name": "Foundation",
...
8. **JSON Must Be Valid**
   - progress.json must parse cleanly
   - Must mirror dev-plan.md exactly
</rules>
